...
namespace Numbers
{
    class Program
    {
        ...
        {
            // unsigned integer mean positive whole number including 0
            ...
            Console.WriteLine(
                $"double {sizeof(double)} bytes and can store numbers in the range {double.MinValue:N0} to {double.MaxValue:N0}.");
            Console.WriteLine(
            ...
            decimal c = 0.1M; // M suffix means a deciaml literal value
            decimal d = 0.2M;
